...
class SyncMessagesService:
    ...
    async def sync_account(self, account_id: str) -> SyncMessagesResult:
        ...
        for message in messages:
            ...
            await self._delivery_repository.save(self._build_delivery(account_id, message))
    ...
    @staticmethod
    def _build_delivery(account_id: str, message: ChannelMessage) -> Delivery:
        return Delivery(
            delivery_id=f"{account_id}:{message.message_id}",
